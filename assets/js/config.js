...
const SUPABASE_URL = "https://rqsrmpgpuinlkzrvggck.supabase.co"; // ganti dengan URL project Anda
const SUPABASE_ANON_KEY = "sb_publishable_09tDL76lbniaOi2u3sjOag_fhWIo3aa"; // publishable key (anon)
